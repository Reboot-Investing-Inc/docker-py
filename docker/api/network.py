    ...
    def create_network(
        ...
        if labels is not None:
            if version_lt(self._version, "1.23"):
                raise InvalidVersion("network labels were introduced in API 1.23")
        ...
        if enable_ipv6:
            if version_lt(self._version, "1.23"):
                raise InvalidVersion("enable_ipv6 was introduced in API 1.23")
        ...
        if ingress is not None:
            if version_lt(self._version, "1.29"):
                raise InvalidVersion("ingress is not supported in API version < 1.29")

            data["Ingress"] = ingress

        if scope is not None:
            if version_lt(self._version, "1.30"):
                raise InvalidVersion("scope is not supported in API version < 1.30")
            data["Scope"] = scope
